...
<head>
    ...
    <link rel="stylesheet" href="./styles/ssss.css">
</head>
<body>
    <div class="container" id="signUp" style="display:none;">
        ...
        <div class="insert-group" enctype="multipart/form-data">
                <label for="imageUpload">
                    <img id="imagePreview" src="./images/avatar.png" alt="Click Here To Upload Image" width="110" height="80" style="cursor: pointer; border: 2px dashed #ccc; display: inline-block;"/> Upload your profile picture
                </label>
        ...
        ?>
            ...
            <div class="input-group">
                <i class="fas fa-lock"></i>
                <input type="Password" name="cPassword" id="cPassword" placeholder="Confirm Password" onkeyup="validatePassword()" required>
